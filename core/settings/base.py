...
ENABLE_CARD_PAYMENTS = env_bool("ENABLE_CARD_PAYMENTS", False)
CARD_PAYMENT_GATEWAY = os.getenv("CARD_PAYMENT_GATEWAY", "placeholder")
CARD_PAYMENT_GATEWAY_CHECKOUT_URL = os.getenv("CARD_PAYMENT_GATEWAY_CHECKOUT_URL", "")
